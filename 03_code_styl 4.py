...
my_poem = ['Смеркалось, хлипкие волны катались по Неве', 'И хрюкали злюки как поросята в навозе',
           'О, бойся Бегемота, сын! Он так свиреп и дик', 'А в глуши рычит исполин - Злочастный Бангладеш!', ]
